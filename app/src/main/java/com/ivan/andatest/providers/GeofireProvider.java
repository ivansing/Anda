...
public class GeofireProvider {
    ...
    public GeofireProvider () {
        mDatabase = FirebaseDatabase.getInstance().getReference("active_drivers");
    ...
    public GeoQuery getActiveDrivers(LatLng latLng) {
        GeoQuery geoQuery = mGeofire.queryAtLocation(new GeoLocation(latLng.latitude, latLng.longitude), 1);
